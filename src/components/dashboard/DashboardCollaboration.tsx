  ...
  return (
    <Card className="bg-zinc-950 border-zinc-900 shadow-sm relative overflow-hidden">
      ...
      <CardHeader className="text-center pb-8 relative z-10">
        ...
        <CardDescription className="text-base max-w-2xl mx-auto mt-3 text-zinc-400">
      ...
      <CardContent className="relative z-10">
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6 hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 group">
          ...
          <div className="bg-zinc-900/60 border border-primary/30 rounded-xl p-6 hover:border-primary/60 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group shadow-[0_0_20px_rgba(201,168,76,0.1)]">
        ...
        <div className="flex justify-center">
          <Button
            asChild
            size="lg"
            className="h-12 px-8 gold-gradient text-black font-bold shadow-[0_0_20px_rgba(201,168,76,0.2)] hover:scale-105 transition-transform duration-300 group"
          >
            <Link to="/suggestions">
