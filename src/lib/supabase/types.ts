...
// Table: partnerships
//   on_partnership_advanced: CREATE TRIGGER on_partnership_advanced AFTER UPDATE OF status ON public.partnerships FOR EACH ROW EXECUTE FUNCTION handle_partnership_advance_reputation()
// Table: profiles
