-- Update handle_new_user_templates function to include the new welcome email template text and link
...
-- Update existing 'Boas-vindas - Email' templates to match the new text
