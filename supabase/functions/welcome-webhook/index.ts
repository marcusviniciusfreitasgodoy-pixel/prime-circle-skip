      ...
      try {
        ...
        if (profile.referred_by_id) {
          ...
          if (!referrerError && referrerProfile?.whatsapp_number) {
            ...
            const refWaMessage = `Olá ${referrerFirstName}! 🚀\n\nO corretor *${newMemberName}* acabou de se cadastrar na Prime Circle usando o seu link de indicação.\n\nAcesse o seu painel de Curadoria para validar o novo membro e liberar o acesso dele à plataforma:\n🔗 https://www.primecircle.app.br/dashboard`
